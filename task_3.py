...
if __name__ == '__main__':
    ...
    # не понял эти данные по pupil, я пологал, что время входа и выхода сортированы,
    #  а так же, что входы и выходы у одного pupil не могут пересекаться,
    #  как указанно на картине.
    ...
    #    },
        ...
        {'data': {'lesson': [100, 1000],
            'pupil': [56, 150, 200, 400, 450, 500, 500, 950],
            'tutor': [50, 150, 500, 950]},
            'answer': 500
        },
        {'data': {'lesson': [100, 10000],
            'pupil': [200, 600, 850, 1200],
            'tutor': [23, 250, 400, 950, 1500, 200]},
            'answer': 350
        }
    ]
